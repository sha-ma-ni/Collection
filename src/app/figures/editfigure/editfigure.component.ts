...
//   form: FormGroup<{ [K in keyof { nameControl: (string | ((control: AbstractControl) => (ValidationErrors | null)))[]; topicControl: (string | ((control: AbstractControl) => (ValidationErrors | null)))[]; purchasePriceControl: (string | ((control: AbstractControl) => (ValidationErrors | null)))[]; articleNumberControl: (string | ((control: AbstractControl) => (ValidationErrors | null)))[]; salePriceControl: (string | ((control: AbstractControl) => (ValidationErrors | null)))[] }]: ɵElement<{ nameControl: (string | ((control: AbstractControl) => (ValidationErrors | null)))[]; topicControl: (string | ((control: AbstractControl) => (ValidationErrors | null)))[]; purchasePriceControl: (string | ((control: AbstractControl) => (ValidationErrors | null)))[]; articleNumberControl: (string | ((control: AbstractControl) => (ValidationErrors | null)))[]; salePriceControl: (string | ((control: AbstractControl) => (ValidationErrors | null)))[] }[K], null> }> = new FormGroup({
